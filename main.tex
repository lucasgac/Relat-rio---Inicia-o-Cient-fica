...
O \textit{mapa exponencial} em um ponto $p \in M$ é a função dada por $\Exp_p(X_p) = \gamma_{X_p}(1)$. Note que podemos assumir que $\gamma_{X_p}$ sempre está definida em $1$, pois caso não esteja, basta reparametrizá-la por algum mapa da forma $\phi(t) = kt$.
