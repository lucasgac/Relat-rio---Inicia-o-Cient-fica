...
O espaço hiperbólico real é uma variedade riemanniana de curvatura constante igual a $-1$. Existem diversos modelos isométricos para ele, e agora vamos falar de alguns.

\subsection{Hiperboloide de Lorentz}

\subsection{Disco de Poincaré}

\subsection{Semi-plano de Poincaré}

\subsection{Disco de Beltrami-Klein}

\subsection{Modelo do Hemisfério}
